...
local MATERIAL_CHOICES = {
    ...
    { material_id = "templebrick_golden_static", display_name = "Fool's Gold", default_keyword = "foolsgold", default_enabled = false  },
    ...
    { material_id = "glowstone_altar_hdr", display_name = "Glowstone Altar HDR", default_keyword = "mint", default_enabled = false  },
